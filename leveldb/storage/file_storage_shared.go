...
func (fw *fileWrap) Read(b []byte) (n int, err error) {
	return fw.File.Read(b)
}

func (fw *fileWrap) ReadAt(b []byte, off int64) (n int, err error) {
	return fw.File.ReadAt(b, off)
}

func (fw *fileWrap) Seek(offset int64, whence int) (ret int64, err error) {
	return fw.File.Seek(offset, whence)
}

func (fw *fileWrap) Write(b []byte) (n int, err error) {
